...
\textit{jaya kapīsa tihũ loka ujāgara ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{ज्ञान} / \telu{జ్ఞాన} / \textit{jñāna} &  \deva{ज्ञानस्य}  &  Of knowledge  &   \\
\deva{गुन} / \telu{గున} / \textit{guna}  &  \deva{गुणानाम्}  &  Of virtues/qualities  & \\ 
\deva{सागर} / \telu{సాగర} / \textit{sāgara}  &  \deva{सागरः}  &  Ocean  &   \\
\deva{कपीस} \gotchaicon / \telu{కపీస} / \textit{kapīsa}  &  \deva{कपीशः (कपि+ईश)}  &  Lord of Monkeys  & \\ 
\deva{तिहुँ} / \telu{తిహుఁ} / \textit{tihũ}  &  \deva{त्रिषु}  &  In the three  & $tri \rightarrow tihu$ \\ 
\deva{लोक} / \telu{లోక} / \textit{loka}  &  \deva{लोकेषु}  &  Worlds  &   \\
\deva{उजागर} / \telu{ఉజాగర} / \textit{ujāgara}  &  \deva{उजागरः (प्रसिद्धः)}  &  Illuminator / Brightness  &   \\
\bottomrule
\end{tabularx}
\end{table}
