...
\midrule
\deva{लाय} / \telu{లాయ}  &  \deva{आनीय}  &  Having brought  &   \\
\deva{सजीवन} \gotchaicon / \telu{సజీవన}  &  \deva{सञ्जीवनीम्}  &  Sanjeevani herb  &   \\
\deva{लखन} / \telu{లఖన}  &  \deva{लक्ष्मणम्}  &  Lakshmana  & \\ 
\deva{जियाये} / \telu{జియాయే}  &  \deva{जीवितवान्}  &  Resurrected / Revived  &   \\
\deva{श्रीरघुबीर} / \telu{శ్రీరఘుబీర}  &  \deva{श्रीरघुवीरः}  &  Lord Rama  & \\ 
\deva{हरषि} / \telu{హరషి}  &  \deva{हर्षितः}  &  Joyfully  & Short ending 'i' \\
\deva{उर} / \telu{ఉర}  &  \deva{उरसि / वक्षसि}  &  In the chest/heart  &   \\
\deva{लाये} / \telu{లాయే}  &  \deva{स्थापितवान्}  &  Brought to (embraced)  &   \\
\bottomrule
\end{tabularx}
\end{table}
