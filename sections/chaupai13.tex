...
\textit{sahasa badana tumharo jasa gāvaĩ |}\\
\textit{asa kahi śrīpati kaṇṭha lagāvaĩ ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{सहस} / \telu{సహస} / \textit{sahasa}  &  \deva{सहस्रम्}  &  Thousand  &   \\
\deva{बदन} / \telu{బదన} / \textit{badana}  &  \deva{वदनम् / मुखानि}  &  Faces  & \\ 
\deva{तुम्हरो} / \telu{తుమ్హరో} / \textit{tumharo}  &  \deva{भवतः}  &  Your  &   \\
\deva{जस} \gotchaicon / \telu{జస} / \textit{jasa}  &  \deva{यशः}  &  Glory / Fame  & \\ 
\deva{गावैं} \gotchaicon / \telu{గావైఁ} / \textit{gāvaĩ}  &  \deva{गायन्ति}  &  (They) Sing  & Plural nasal `-ain` \\
\deva{अस} / \telu{అస} / \textit{asa}  &  \deva{एवम्}  &  Like this / Thus  &   \\
\deva{कहि} / \telu{కహి} / \textit{kahi}  &  \deva{उक्त्वा}  &  Having said  & Absolutive verb `-i` \\
\deva{श्रीपति} / \telu{శ్రీపతి} / \textit{śrīpati}  &  \deva{श्रियः-पतिः}  &  Lord of Fortune (Rama)  &   \\
\deva{कंठ} / \telu{కంఠ} / \textit{kaṇṭha}  &  \deva{कण्ठे}  &  By the neck  &   \\
\deva{लगावैं} \gotchaicon / \telu{లగావైఁ} / \textit{lagāvaĩ}  &  \deva{आलिङ्गितवान्}  &  Hugged / Applied  &   \\
\bottomrule
\end{tabularx}
\end{table}
