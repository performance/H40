...
\textbf{The Universal Scholar:} Sages, gods, and cosmic figures (Sanaka, Brahma, Narada, Sarasvati, and Shesha) praise Hanuman's intellectual greatness. In the *Valmiki Ramayana* (*Kishkindha Kanda, 3:28-32*), Rama marvels at Hanuman's flawless speech and mastery of the Vedas and grammar, stating that even a king with such a brilliant advisor/envoy succeeds in all his endeavors.
\vspace{0.5em}\newline Hanuman's intellectual genius is praised by the highest scholars, sages, and divine beings of the universe.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=4&language=dv&field_sarga_value=3}{\textit{Kishkindha Kanda, 3:28-32}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{सनकादिक} / \telu{సనకాదిక} / \textit{sanakādika}  &  \deva{सनकादयः}  &  Sages like Sanaka  &   \\
\deva{ब्रह्मादि} / \telu{బ్రహ్మాది} / \textit{brahmādi}  &  \deva{ब्रह्मादयः देवाः}  &  Gods like Brahma  &   \\
\deva{मुनीसा} \gotchaicon / \telu{మునీసా} / \textit{munīsā}  &  \deva{मुनीशाः (मुनि+ईश)}  &  Chief sages  & \\ 
\deva{नारद} / \telu{నారద} / \textit{nārada}  &  \deva{नारदः}  &  Sage Narada  &   \\
\deva{सारद} \gotchaicon / \telu{సారద} / \textit{sārada}  &  \deva{शारदा / सरस्वती}  &  Goddess Saraswati  & \\ 
\deva{सहित} / \telu{సహిత} / \textit{sahita}  &  \deva{सहिताः / सह}  &  Along with  &   \\
\deva{अहीसा} \gotchaicon / \telu{అహీసా} / \textit{ahīsā}  &  \deva{अहीशः (अहि+ईश)}  &  Lord of Snakes (Shesha)  & \\ 
\bottomrule
\end{tabularx}
\end{table}
