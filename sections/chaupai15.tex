...
\textit{jamu kubera digapāla jahā̃ te |}\\
\textit{kabi kobida kahi sake kahā̃ te ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{जमु} / \telu{జము} / \textit{jamu}  &  \deva{यमः}  &  God of Death  & \\ 
\deva{कुबेर} / \telu{కుబేర} / \textit{kubera}  &  \deva{कुबेरः}  &  God of Wealth  &   \\
\deva{दिगपाल} / \telu{దిగపాల} / \textit{digapāla}  &  \deva{दिक्पालाः}  &  Direction Guardians  & $k \rightarrow g$ shift \\ 
\deva{जहाँ ते} / \telu{జహాం తే} / \textit{jahā̃ te}  &  \deva{यत्र / यस्मात्}  &  Where from / Even they  &   \\
\deva{कबि} / \telu{కబి} / \textit{kabi}  &  \deva{कविः}  &  Poet  & \\ 
\deva{कोबिद} / \telu{కోబిద} / \textit{kobida}  &  \deva{कोविदः (पण्डितः)}  &  Scholar  & \\ 
\deva{कहि सके} / \telu{కహి సకే} / \textit{kahi sake}  &  \deva{वक्तुं शक्नुवन्ति}  &  Can say/describe  &   \\
\deva{कहाँ ते} / \telu{కహాం తే} / \textit{kahā̃ te}  &  \deva{कुतः / कथम्}  &  How / From where  &   \\
\bottomrule
\end{tabularx}
\end{table}
