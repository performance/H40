...
\textit{tuma upakāra sugrīvahiṃ kīnhā |}\\
...
\deva{उपकार} / \telu{ఉపకార}  &  \deva{उपकारम्}  &  Favor / Service  &   \\
\deva{सुग्रीवहिं} \gotchaicon / \telu{సుగ్రీవహిఁ}  &  \deva{सुग्रीवाय}  &  To Sugriva  & Objective suffix `-hiṃ` \\
\deva{कीन्हा} \gotchaicon / \telu{కీన్హా}  &  \deva{कृतवान्}  &  Did  & Awadhi past tense \\
\deva{राम मिलाय} / \telu{రామ మిలాయ}  &  \deva{रामेण मेलयित्वा}  &  Having united with Rama  &   \\
\deva{राज पद} / \telu{రాజ పద}  &  \deva{राज-पदम्}  &  Royal Throne  &   \\
\deva{दीन्हा} / \telu{దీన్హా}  &  \deva{दत्तवान्}  &  Gave  & Rhymes with keenhaa \\
\bottomrule
\end{tabularx}
\end{table}
