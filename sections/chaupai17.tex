...
\midrule
\deva{तुम्हरो} / \telu{తుమ్హరో}  &  \deva{भवतः}  &  Your  &  Awadhi possessive; syncopated from \deva{तुम्हारो} \\
\deva{मंत्र} / \telu{మంత్ర}  &  \deva{मन्त्रम् (उपदेशम्)}  &  Word / Counsel  &   \\
\deva{बिभीषन} / \telu{బిభీషన}  &  \deva{विभीषणः}  &  Vibhishana  &  $v \rightarrow b$  \\
\deva{माना} / \telu{మానా}  &  \deva{अङ्गीकृतवान्}  &  Accepted / Heeded  &   \\
\deva{लंकेस्वर} / \telu{లంకేశ్వర}  &  \deva{लङ्केश्वरः}  &  King of Lanka  &  Compound: \deva{लंका} + \deva{ईश्वर} \\
\deva{भए} / \telu{భఏ}  &  \deva{अभवत्}  &  Became  &   \\
\deva{सब जग} / \telu{సబ జగ}  &  \deva{सर्वं जगत्}  &  The whole world  &   \\
\deva{जाना} / \telu{జానా}  &  \deva{जानाति}  &  Knows  &   \\
\bottomrule
\end{tabularx}
\end{table}
