...
\midrule
\deva{जुग} \glossaryicon / \telu{జుగ}  &  \deva{युग}  &  Yuga (Era/Distance)  & \\ 
\deva{सहस्र} / \telu{సహస్ర}  &  \deva{सहस्र}  &  Thousand  &   \\
\deva{जोजन} / \telu{జోజన}  &  \deva{योजन}  &  Yojana (approx 8 miles)  & \\ 
\deva{पर} / \telu{పర}  &  \deva{दूरे / परत्र}  &  Away / At a distance  &   \\
\deva{भानू} / \telu{భానూ}  &  \deva{भानुम्}  &  The Sun  & Long `ū` for rhyme \\
\deva{लील्यो} / \telu{లీల్యో}  &  \deva{लीलया निगीर्णवान्}  &  Swallowed playfully  &   \\
\deva{ताहि} / \telu{తాహి}  &  \deva{तम्}  &  It (the sun)  & Awadhi objective \\
\deva{मधुर फल} / \telu{మధుర ఫల}  &  \deva{मधुर-फलम्}  &  Sweet fruit  &   \\
\deva{जानू} / \telu{జానూ}  &  \deva{ज्ञात्वा / मत्वा}  &  Knowing / Thinking  & Long `ū` for rhyme \\
\bottomrule
\end{tabularx}
\end{table}
