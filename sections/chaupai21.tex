...
\midrule
\deva{राम दुआरे} / \telu{రామ దుఆరే} / \textit{rāma duāre}  &  \deva{रामस्य द्वारे}  &  At Rama's door  & `duaare` is locative \\
\deva{तुम} \gotchaicon / \telu{తుమ} / \textit{tuma}  &  \deva{त्वम्}  &  You  &   \\
\deva{रखवारे} / \telu{రఖవారే} / \textit{rakhavāre}  &  \deva{रक्षकः}  &  Protector / Guard  & \\ 
\deva{होत न} / \telu{హోత న} / \textit{hota na}  &  \deva{न भवति}  &  Does not happen  &   \\
\deva{आज्ञा} / \telu{ఆజ్ఞా} / \textit{ājñā}  &  \deva{आज्ञाम्}  &  Command / Permission  &   \\
\deva{बिनु} / \telu{బిను} / \textit{binu}  &  \deva{विना}  &  Without  &   \\
\deva{पैसारे} / \telu{పైసారే} / \textit{paisāre}  &  \deva{प्रवेशः}  &  Entry / Passage  & Awadhi noun \\
\bottomrule
\end{tabularx}
\end{table}
