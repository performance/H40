...
\midrule
\deva{सब सुख} / \telu{సబ సుఖ}  &  \deva{सर्वाणि सुखानि}  &  All happiness  &   \\
\deva{लहै} / \telu{లహై}  &  \deva{लभते}  &  Obtains / gets  & Verb ending in `-ai` \\
\deva{तुम्हारी} / \telu{తుమ్హారీ}  &  \deva{भवतः}  &  Your  &   \\
\deva{सरना} / \telu{సరనా}  &  \deva{शरणम्}  &  Shelter / Refuge  & \\ 
\deva{तुम} \gotchaicon / \telu{తుమ}  &  \deva{त्वम्}  &  You  &   \\
\deva{रच्छक} \gotchaicon / \telu{రచ్ఛక}  &  \deva{रक्षकः}  &  Protector  & \\ 
\deva{काहू को} / \telu{కాహూ కో}  &  \deva{कस्यापि}  &  For anyone  &   \\
\deva{डर ना} / \telu{డర నా}  &  \deva{भयं नास्ति}  &  No fear  &   \\
\bottomrule
\end{tabularx}
\end{table}
