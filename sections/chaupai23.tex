...
\textit{tīnoṃ loka hāṃka teṃ kāṃpai ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{आपन} / \telu{ఆపన}  &  \deva{आत्मीयम्}  &  Own  &   \\
\deva{तेज} / \telu{తేజ}  &  \deva{तेजः}  &  Power / Splendor  &   \\
\deva{सम्हारो} / \telu{సమ్హారో}  &  \deva{सम्भालनम् / नियन्त्रणम्}  &  Control / Handle  &   \\
\deva{आपै} / \telu{ఆపై}  &  \deva{स्वयम् एव}  &  You alone / By yourself  &   \\
\deva{तीनों लोक} / \telu{తీనోం లోక}  &  \deva{त्रयः लोकाः}  &  Three worlds  &   \\
\deva{हाँक तें} / \telu{హాఁక తేఁ}  &  \deva{हुङ्कारेण / गर्जनया}  &  By your roar  &   \\
\deva{काँपै} / \telu{కాఁపై}  &  \deva{कम्पन्ते}  &  Tremble / Shiver  &   \\
\bottomrule
\end{tabularx}
\end{table}
