...
\textit{bhūta pisāca nikaṭa nahĩ āvai |}\\
...
\textbf{Mental Armor:} Instead of literal ghosts, the \textit{Bhoot Pisach} represent the "ghosts" of performance anxiety, self-doubt, and negative peer pressure. Keeping strong role models in mind and practicing positive self-talk acts as mental armor against toxic thoughts that try to derail our focus.
\vspace{0.5em}\newline Standing alone in a hostile court, his absolute focus acted as impenetrable mental armor against toxic peer pressure.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=5&language=dv&field_sarga_value=50}{\textit{Sundara Kanda, 50:14-16}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{भूत} / \telu{భూత}  &  \deva{भूताः}  &  Ghosts  &   \\
\deva{पिसाच} / \telu{పిసాచ}  &  \deva{पिशाचाः}  &  Evil spirits / Ghouls  & \\ 
\deva{निकट} / \telu{నికట}  &  \deva{निकटम् / समीपम्}  &  Near / Close  &   \\
\deva{नहिं आवै} / \telu{నహిఁ ఆవై}  &  \deva{न आगच्छन्ति}  &  Do not come  &   \\
\deva{महाबीर} / \telu{మహాబీర}  &  \deva{महावीरः}  &  Mahaveer (Great Hero)  & \\ 
\deva{जब} / \telu{జబ}  &  \deva{यदा}  &  When  & \\ 
\deva{नाम} / \telu{నామ}  &  \deva{नाम}  &  Name  &   \\
\deva{सुनावै} / \telu{సునావై}  &  \deva{श्रावयति}  &  Is heard / recited  & Causative verb \\
\bottomrule
\end{tabularx}
\end{table}
