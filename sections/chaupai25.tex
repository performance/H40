...
\midrule
\deva{नासै} \gotchaicon / \telu{నాసై}  &  \deva{नश्यति}  &  Is destroyed  & Verb ending in `-ai` \\
\deva{रोग} / \telu{రోగ}  &  \deva{रोगाः}  &  Diseases  &   \\
\deva{हरै} \gotchaicon / \telu{హరై}  &  \deva{हरति}  &  Takes away / destroys  & Verb ending in `-ai` \\
\deva{सब पीरा} / \telu{సబ పీరా}  &  \deva{सर्वाः पीडाः}  &  All pain  & \deva{पीडा $\rightarrow$ पीरा} \\ 
\deva{जपत} / \telu{జపత}  &  \deva{जपन्}  &  Chanting  & Continuous action `-ta` \\
\deva{निरन्तर} / \telu{నిరంతర}  &  \deva{निरन्तरम्}  &  Continuously  &   \\
\deva{हनुमत} / \telu{హనుమత}  &  \deva{हनुमन्}  &  Hanuman  &   \\
\deva{बीरा} / \telu{బీరా}  &  \deva{वीरः}  &  Brave/Hero  & \par  \deva{} \\ 
\bottomrule
\end{tabularx}
\end{table}
