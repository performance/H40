...
\textit{saṃkaṭa teṃ hanumāna chuṛāvai |}\\
...
\midrule
\deva{संकट तें} / \telu{సంకట తేఁ}  &  \deva{सङ्कटात्}  &  From crisis  & Ablative postposition `-teṃ` \\
\deva{हनुमान} / \telu{హనుమాన}  &  \deva{हनुमान्}  &  Hanuman  &   \\
\deva{छुड़ावै} / \telu{ఛుడావై}  &  \deva{मोचयति}  &  Rescues/Frees  &   \\
\deva{मन} / \telu{మన}  &  \deva{मनसा}  &  With mind  &   \\
\deva{क्रम} / \telu{క్రమ}  &  \deva{कर्मणा}  &  With actions  & Metathesis of Karma \\
\deva{बचन} / \telu{బచన}  &  \deva{वचनेन}  &  With words  & \\ 
\deva{ध्यान} / \telu{ధ్యాన}  &  \deva{ध्यानम्}  &  Meditation  &   \\
\deva{जो लावै} / \telu{జో లావై}  &  \deva{यः करोति (आनयति)}  &  Whoever applies  &   \\
\bottomrule
\end{tabularx}
\end{table}
