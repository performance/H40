...
\midrule
\deva{और} / \telu{ఔర} / \textit{aura}  &  \deva{अन्य / अपरः}  &  And / Other  &   \\
\deva{मनोरथ} / \telu{మనోరథ} / \textit{manoratha}  &  \deva{मनोरथम्}  &  Desire / Wish  &   \\
\deva{जो कोइ} / \telu{జో కోఇ} / \textit{jo koi}  &  \deva{यः कश्चित्}  &  Whoever  &   \\
\deva{लावै} / \telu{లావై} / \textit{lāvai}  &  \deva{आनयति}  &  Brings  &   \\
\deva{सोइ} / \telu{సోఇ} / \textit{soi}  &  \deva{सः एव}  &  That very person  & Awadhi pronoun \\
\deva{अमित} / \telu{అమిత} / \textit{amita}  &  \deva{अमितम् / असीमम्}  &  Limitless / Infinite  &   \\
\deva{जीवन फल} / \telu{జీవన ఫల} / \textit{jīvana phala}  &  \deva{जीवन-फलम्}  &  Fruit of life  &   \\
\deva{पावै} / \telu{పావై} / \textit{pāvai}  &  \deva{प्राप्नोति}  &  Obtains  &   \\
\bottomrule
\end{tabularx}
\end{table}
