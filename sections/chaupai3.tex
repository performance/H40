...
\midrule
\deva{महाबीर} / \telu{మహాబీర}  &  \deva{महावीरः}  &  Great Hero  & \\ 
\deva{बिक्रम} \gotchaicon / \telu{బిక్రమ}  &  \deva{विक्रमः}  &  Valiant/Courageous  & \\ 
\deva{बजरंगी} / \telu{బజరంగీ}  &  \deva{वज्राङ्गी}  &  Thunderbolt body  & Swara-Bhakti splitting \\
\deva{कुमति} / \telu{కుమతి}  &  \deva{कुमतिम्}  &  Evil intellect  &   \\
\deva{निवार} \gotchaicon / \telu{నివార}  &  \deva{निवारकः}  &  Dispeller / Remover  & Meter trap: short 'i' \\
\deva{सुमति} / \telu{సుమతి}  &  \deva{सुमतीनाम्}  &  Good intellect  &   \\
\deva{संगी} / \telu{సంగీ}  &  \deva{सङ्गी / सखा}  &  Companion  &   \\
\bottomrule
\end{tabularx}
\end{table}
