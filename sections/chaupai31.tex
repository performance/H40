...
\midrule
\deva{अष्ट सिद्धि} \glossaryicon / \telu{అష్ట సిద్ధి}  &  \deva{अष्ट-सिद्धिः}  &  8 Supernatural Powers  & e.g., shrinking/expanding \\
\deva{नौ निधि} \glossaryicon / \telu{నౌ నిధి}  &  \deva{नव-निधिः}  &  9 Divine Treasures  & e.g., endless wealth \\
\deva{के दाता} / \telu{కే దాతా}  &  \deva{प्रदाता}  &  Giver / Bestower of  &   \\
\deva{अस बर} / \telu{అస బర}  &  \deva{एतादृशं वरम्}  &  Such a boon  &   \\
\deva{दीन} / \telu{దీన}  &  \deva{दत्तवती}  &  Gave  & Past tense verb \\
\deva{जानकी माता} / \telu{జానకీ మాతా}  &  \deva{माता जानकी}  &  Mother Janaki (Sita)  &   \\
\bottomrule
\end{tabularx}
\end{table}
