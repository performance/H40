...
\textit{jahāṃ janma haribhakta kahāī ||}
\par}
\end{minipage}%
\hfill
...
\textbf{The Ultimate Destination:} By dedicating our life to a noble path and consistent hard work, we ensure that our personal legacy (\textit{Anta Kaal}) is secure, and we will be remembered as someone who brought positive value to the world.
\vspace{0.5em}\newline By dedicating his life to a noble path, he guaranteed his legacy would be remembered for bringing positive value to the world.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=6&language=dv&field_sarga_value=128}{\textit{Yuddha Kanda, 128:106}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{अन्त काल} / \telu{అన్త కాల}  &  \deva{अन्त्य-काले}  &  At the end of life  &   \\
\deva{रघुबर पुर} / \telu{రఘుబర పుర}  &  \deva{श्रीराम-धाम}  &  Rama's celestial city  & \\ 
\deva{जाई} / \telu{జాయీ}  &  \deva{गच्छति}  &  Goes / Reaches  &   \\
\deva{जहाँ} / \telu{జహాఁ}  &  \deva{यत्र}  &  Where / Wherever  &   \\
\deva{जन्म} / \telu{జన్మ}  &  \deva{जन्म}  &  Birth  & Pure Sanskrit \\
\deva{हरिभक्त} / \telu{హరిభక్త}  &  \deva{हरि-भक्तः}  &  Devotee of God  &   \\
\deva{कहाई} / \telu{కహాయీ}  &  \deva{कथ्यते / उच्यते}  &  Is called / renowned  & Passive voice \\
\bottomrule
\end{tabularx}
\end{table}
