...
\midrule
\deva{और} / \telu{ఔర} / \textit{aura}  &  \deva{अन्य / परः}  &  Other  &   \\
\deva{देवता} / \telu{దేవతా} / \textit{devatā}  &  \deva{देवता}  &  Deity / Gods  &   \\
\deva{चित्त} / \telu{చిత్త} / \textit{citta}  &  \deva{चित्ते / मनसि}  &  In the mind  &   \\
\deva{न धरई} / \telu{న ధరఈ} / \textit{na dharaī}  &  \deva{न धरति}  &  Does not hold/keep  & `y` $\rightarrow$ `ee` verb \\ 
\deva{हनुमंत} / \telu{హనుమంత} / \textit{hanumata}  &  \deva{हनुमन्तम्}  &  Hanuman  &   \\
\deva{सेइ} / \telu{సేఇ} / \textit{sei}  &  \deva{सेवया / आराध्य}  &  By serving  & Absolutive `-i` ending \\
\deva{सर्ब सुख} \gotchaicon / \telu{సర్బ సుఖ} / \textit{sarba sukha}  &  \deva{सर्व-सुखानि}  &  All happiness  &  \\ 
\deva{करई} / \telu{కరఈ} / \textit{karaī}  &  \deva{करोति}  &  Achieves / Does  & `y` $\rightarrow$ `ee` verb \\ 
\bottomrule
\end{tabularx}
\end{table}
