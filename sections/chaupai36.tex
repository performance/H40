...
\textit{saṃkaṭa kaṭai miṭai saba pīrā |}\\
...
\textbf{Active Resilience:} He doesn't just passively soothe problems; the active verb \textit{Kaṭai} (cutting) means we must take decisive, active steps to cut out the bad habits and negative influences that are causing our struggles. Resilience requires action.
\vspace{0.5em}\newline He took decisive, active steps to cut through the binds tying him down, proving resilience requires bold action.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=5&language=dv&field_sarga_value=48}{\textit{Sundara Kanda, 48:45-50}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{संकट कटै} / \telu{సంకట కటై}  &  \deva{सङ्कटं छिद्यते}  &  Crisis is cut  & Present tense `-ai` \\
\deva{मिटै} / \telu{మిటై}  &  \deva{मृज्यते (नश्यति)}  &  Is erased/mitigated  &   \\
\deva{सब पीरा} / \telu{సబ పీరా}  &  \deva{सर्वाः पीडाः}  &  All pain  & \deva{पीडा $\rightarrow$ पीरा} \\ 
\deva{जो सुमिरै} / \telu{జో సుమిరై}  &  \deva{यः स्मरति}  &  Whoever remembers  & Swara-Bhakti (Smara $\rightarrow$ Sumira) \\ 
\deva{हनुमत} / \telu{హనుమత}  &  \deva{हनुमन्तम्}  &  Hanuman  &   \\
\deva{बलबीरा} \gotchaicon / \telu{బలబీరా}  &  \deva{बलवीरम्}  &  Mighty and Brave  &  \\ 
\bottomrule
\end{tabularx}
\end{table}
