...
\midrule
\deva{जो यह} / \telu{జో యహ} / \textit{jo yaha}  &  \deva{यः एतत्}  &  Whoever this  &   \\
\deva{पढ़ै} / \telu{పఢై} / \textit{paṛhai}  &  \deva{पठति}  &  Reads  & Verb ending in `-ai` \\
\deva{हनुमान चलीसा} / \telu{హనుమాన చలీసా} / \textit{hanumāna calīsā}  &  \deva{हनुमान-चालीसा}  &  Forty verses of Hanuman  &   \\
\deva{होय सिद्धि} / \telu{హోయ సిద్ధి} / \textit{hoya siddhi}  &  \deva{सिद्धिः भवति}  &  Success/Perfection happens  &   \\
\deva{साखी} \gotchaicon / \telu{సాఖీ} / \textit{sākhī}  &  \deva{साक्षी}  &  Witness  & \\ 
\deva{गौरीसा} / \telu{గౌరీసా} / \textit{gaurīsā}  &  \deva{गौरीशः (शिवः)}  &  Lord of Gauri  & \\ 
\bottomrule
\end{tabularx}
\end{table}
