...
\midrule
\deva{कंचन} / \telu{కంచన} / \textit{kañcana}  &  \deva{कञ्चन / सुवर्णम्}  &  Gold  &   \\
\deva{बरन} / \telu{బరన} / \textit{barana}  &  \deva{वर्णः}  &  Complexion / Color  & \\ 
\deva{बिराज} / \telu{బిరాజ} / \textit{birāja}  &  \deva{विराजते}  &  Shines / Is adorned  & \\ 
\deva{सुबेसा} \gotchaicon / \telu{సుబేసా} / \textit{subesā}  &  \deva{सुवेषः}  &  Beautiful attire  & \\ 
\deva{कानन} / \telu{కానన} / \textit{kānana}  &  \deva{कर्णयोः}  &  In the ears  & \\ 
\deva{कुंडल} / \telu{కుండల} / \textit{kuṇḍala}  &  \deva{कुण्डले}  &  Earrings  &   \\
\deva{कुंचित} / \telu{కుంచిత} / \textit{kuñcita}  &  \deva{कुञ्चिताः}  &  Curly  &   \\
\deva{केसा} / \telu{కేసా} / \textit{kesā}  &  \deva{केशाः}  &  Hair  & \\ 
\bottomrule
\end{tabularx}
\end{table}
