...
\textit{kījai nātha hṛdaya mahã ḍerā ||}
\par}
\end{minipage}%
\hfill
...
\textbf{Egoless Honor:} True greatness and peace begin with a humble, egoless mind (\textit{Hriday Maha Dera}). In the *Valmiki Ramayana* (*Yuddha Kanda, 128:81-83*), when Sita presents Hanuman with the highest honor of a divine pearl necklace, Hanuman accepts it with absolute humility and devotion, demonstrating that he values the love and grace of the divine far more than any material decoration.
\vspace{0.5em}\newline Hanuman accepted the highest honors not with personal pride, but with a humble and devoted heart, keeping Rama and Sita in his mind.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=6&language=dv&field_sarga_value=128}{\textit{Yuddha Kanda, 128:81-83}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{तुलसीदास} / \telu{తులసీదాస} / \textit{tulasīdāsa}  &  \deva{तुलसीदासः}  &  Tulsidas (The Author)  &   \\
\deva{सदा} / \telu{సదా} / \textit{sadā}  &  \deva{सर्वदा}  &  Always  &   \\
\deva{हरि चेरा} / \telu{హరి చేరా} / \textit{hari cerā}  &  \deva{हरेः सेवकः}  &  Servant of God  & `Chera` is pure Awadhi for servant \\
\deva{कीजै} / \telu{కీజై} / \textit{kījai}  &  \deva{कुर्यात् / करोतु}  &  Please do / Make  & Respectful Imperative \\
\deva{नाथ} / \telu{నాథ} / \textit{nātha}  &  \deva{नाथ}  &  O Lord  &   \\
\deva{हृदय महँ} / \telu{హృదయ మహఁ} / \textit{hṛdaya mahã}  &  \deva{हृदय-मध्ये}  &  In the heart  & Locative postposition `mahan` \\
\deva{डेरा} / \telu{డేరా} / \textit{ḍerā}  &  \deva{आवासम्}  &  Camp / Dwelling  &   \\
\bottomrule
\end{tabularx}
\end{table}
\vspace{0.5em}
