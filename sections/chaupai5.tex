...
\textit{kā̃dhe mū̃ja janeū sājai ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{हाथ} / \telu{హాథ} / \textit{hātha}  &  \deva{हस्ते}  &  In hands  &   \\
\deva{बज्र} \gotchaicon / \telu{బజ్ర} / \textit{bajra}  &  \deva{वज्रम्}  &  Thunderbolt  & \\ 
\deva{औ} / \telu{ఔ} / \textit{au}  &  \deva{और / च}  &  And  &   \\
\deva{ध्वजा} / \telu{ధ్వజా} / \textit{dhvajā}  &  \deva{ध्वजः}  &  Flag / Banner  &   \\
\deva{बिराजै} / \telu{బిరాజై} / \textit{birājai}  &  \deva{विराजते}  &  Shines  &   \\
\deva{काँधे} \gotchaicon / \telu{కాఁధే} / \textit{kā̃dhe} & \deva{स्कन्धे} & On the shoulder & \\
\deva{मूँज} \gotchaicon / \telu{మూఁజ} / \textit{mū̃ja} & \deva{मौञ्जी} & Munja grass & Moon-dot (Chandrabindu) \\
\deva{जनेऊ} / \telu{జనేఊ} / \textit{janeū}  &  \deva{यज्ञोपवीतम्}  &  Sacred thread  &   \\
\deva{साजै} / \telu{సాజై} / \textit{sājai}  &  \deva{सज्जते / शोभते}  &  Adorns / Looks beautiful  &   \\
\bottomrule
\end{tabularx}
\end{table}
