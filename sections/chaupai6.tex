...
\textit{saṃkara suvana kesarī naṃdana |}\\
\textit{teja pratāpa mahā jaga baṃdana ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{संकर} \gotchaicon / \telu{సంకర}  &  \deva{शङ्करस्य}  &  Of Shiva  & \\ 
\deva{सुवन} \gotchaicon / \telu{సువన}  &  \deva{सुवनः / अवतारः}  &  Incarnation/Son  &   \\
\deva{केसरी नंदन} / \telu{కేసరీ నందన}  &  \deva{केसरी-नन्दनः}  &  Son of Kesari  &   \\
\deva{तेज} / \telu{తేజ}  &  \deva{तेजः}  &  Radiance  &   \\
\deva{प्रताप} / \telu{ప్రతాప}  &  \deva{प्रतापः}  &  Valor / Majesty  &   \\
\deva{महा} / \telu{మహా}  &  \deva{महान्}  &  Great  &   \\
\deva{जग} / \telu{జగ}  &  \deva{जगत्}  &  Universe  &   \\
\deva{बंदन} \gotchaicon / \telu{బందన}  &  \deva{वन्द्यः / वन्दनम्}  &  Revered / Worshipped  & \\ 
\bottomrule
\end{tabularx}
\end{table}
