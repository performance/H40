...
\textbf{The Dedicated Executive:} Hanuman combines deep intellectual training (\textit{Bidyavan}) and virtue (\textit{Guni}) with an intense eagerness to execute Lord Rama's work. In the *Valmiki Ramayana* (*Kishkindha Kanda, 44:11*), Rama praises Hanuman by stating that in him alone reside strength, intellect, prowess, adaptability to time and place, and moral guidance.
\vspace{0.5em}\newline Hanuman's readiness to execute the work represents the perfect combination of deep knowledge and active dedication.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=4&language=dv&field_sarga_value=44}{\textit{Kishkindha Kanda, 44:11}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{बिद्यावान} \gotchaicon / \telu{బిద్యావాన} / \textit{bidyāvāna}  &  \deva{विद्यावान्}  &  Learned / Scholar  & \\ 
\deva{गुनी} / \telu{గునీ} / \textit{gunī}  &  \deva{गुणी (गुणवान्)}  &  Virtuous  &   \\
\deva{अति} / \telu{అతి} / \textit{ati}  &  \deva{अतीव}  &  Extremely  &   \\
\deva{चातुर} / \telu{చాతుర} / \textit{cātura}  &  \deva{चतुरः}  &  Clever  &   \\
\deva{राम काज} / \telu{రామ కాజ} / \textit{rāma kāja}  &  \deva{श्रीरामस्य कार्यम्}  &  Rama's work  & Prakrit shift () \\ 
\deva{करिबे को} / \telu{కరిబే కో} / \textit{karibe ko}  &  \deva{कर्तुम्}  &  To do (Infinitive)  & Awadhi infinitive \\
\deva{आतुर} / \telu{ఆతుర} / \textit{ātura}  &  \deva{आतुरः (उत्सुकः)}  &  Eager / Ready  &   \\
\bottomrule
\end{tabularx}
\end{table}
