...
\textbf{The Art of Listening:} He is praised for being exceptionally eager to listen (\textit{Sunibe ko Rasiya}). The most powerful figure in the entire epic is fundamentally a remarkably attentive listener. Great students and future leaders know that listening and absorbing information is often far more powerful than speaking.
\vspace{0.5em}\newline He rejected ultimate heavenly rewards so he could stay on earth to continue listening and learning.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=6&language=dv&field_sarga_value=128}{\textit{Yuddha Kanda, 128:104}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{प्रभु} / \telu{ప్రభు}  &  \deva{प्रभोः}  &  Lord's  &   \\
\deva{चरित्र} / \telu{చరిత్ర}  &  \deva{चरित्रम् / कथाम्}  &  Character / Stories  &   \\
\deva{सुनिबे को} / \telu{సునిబే కో}  &  \deva{श्रोतुम्}  &  To listen  & Awadhi infinitive verb \\
\deva{रसिया} / \telu{రసియా}  &  \deva{रसिकः}  &  One who relishes  &   \\
\deva{राम} / \telu{రామ}  &  \deva{श्रीरामः}  &  Rama  &   \\
\deva{लखन} \gotchaicon / \telu{లఖన}  &  \deva{लक्ष्मणः}  &  Lakshmana  & cluster simplification \\ 
\deva{सीता} \gotchaicon / \telu{సీతా}  &  \deva{सीता} \gotchaicon  &  Sita  &   \\
\deva{मन} / \telu{మన}  &  \deva{मनसि}  &  In the mind  &   \\
\deva{बसिया} \gotchaicon / \telu{బసియా}  &  \deva{वसन्ति / वासी}  &  Reside / Dweller  & \\ 
\bottomrule
\end{tabularx}
\end{table}
