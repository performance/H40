...
\textit{sūkṣma rūpa dhari siyahĩ dikhāvā |}\\
\textit{bikaṭa rūpa dhari laṅka jarāvā ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{सूक्ष्म रूप} / \telu{సూక్ష్మ రూప} / \textit{sūkṣma rūpa}  &  \deva{सूक्ष्म-रूपम्}  &  Microscopic form  &   \\
\deva{धरि} / \telu{ధరి} / \textit{dhari}  &  \deva{धृत्वा}  &  Having assumed  &   \\
\deva{सियहिं} \gotchaicon / \telu{సియహిఁ} / \textit{siyahĩ}  &  \deva{सीतायै}  &  To Mother Sita  & Dative case suffix -hiṃ \\
\deva{दिखावा} / \telu{దిఖావా} / \textit{dikhāvā}  &  \deva{दर्शितवान्}  &  Showed / Revealed  &   \\
\deva{बिकट रूप} / \telu{బికట రూప} / \textit{bikaṭa rūpa}  &  \deva{विकट-रूपम्}  &  Terrifying form  & \\ 
\deva{धरि} / \telu{ధరి} / \textit{dhari}  &  \deva{धृत्वा}  &  Having assumed  &   \\
\deva{लंक} / \telu{లంక} / \textit{laṅka}  &  \deva{लङ्काम्}  &  Lanka  &   \\
\deva{जरावा} / \telu{జరావా} / \textit{jarāvā}  &  \deva{ज्वालितवान्}  &  Burned  & Jval $\rightarrow$ Jaraavaa \\ 
\bottomrule
\end{tabularx}
\end{table}
