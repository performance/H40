...
\textit{baranaũ raghubara bimala jasu, jo dāyaku phala cāri ||}
\par}
\end{minipage}%
\hfill
...
\midrule
\deva{श्रीगुरु} / \telu{శ్రీగురు}  &  \deva{श्रीगुरोः}  &  Venerable Guru's  & Genitive (-ḥ) \\
\deva{चरन} / \telu{చరన}  &  \deva{चरण}  &  Feet  & \\ 
\deva{सरोज} / \telu{సరోజ}  &  \deva{कमल}  &  Lotus  &   \\
\deva{रज} / \telu{రజ}  &  \deva{धूलिः / रजः}  &  Dust  &   \\
\deva{निज} / \telu{నిజ}  &  \deva{स्व / आत्मीय}  &  Own  &   \\
\deva{मनु} / \telu{మను}  &  \deva{मनः}  &  Mind  &   \\
\deva{मुकुरु} \gotchaicon / \telu{ముకురు}  &  \deva{दर्पणम्}  &  Mirror  & Nominative -u ending \\
\deva{सुधारि} \gotchaicon / \telu{సుధారి}  &  \deva{स्वच्छं कृत्वा (संशोध्य)}  &  Having cleaned/purified  &   \\
\deva{बरनउँ} / \telu{బరనఉఁ}  &  \deva{वर्णयामि}  &  I describe / narrate  & \\ 
\deva{रघुबर} / \telu{రఘుబర}  &  \deva{श्रीरघुनाथस्य}  &  Lord Rama's  & \\ 
\deva{बिमल} / \telu{బిమల}  &  \deva{निर्मलम्}  &  Pure  & \\ 
\deva{जसु} \gotchaicon / \telu{జసు}  &  \deva{यशः}  &  Glory  & \\ 
\deva{जो} / \telu{జో}  &  \deva{यत्}  &  Which  &   \\
\deva{दायकु} \gotchaicon / \telu{దాయకు}  &  \deva{दायकम् (फलप्रदम्)}  &  Bestower / Giver  & Nominative -u ending \\
\deva{फल चारि} \glossaryicon / \telu{ఫల చారి}  &  \deva{चत्वारि फलानि}  &  Four fruits  &   \\
\bottomrule
\end{tabularx}
\end{table}
