...
\textit{buddhihīna tanu jānike, sumiraũ pavana kumāra |}\\
\textit{bala budhi bidyā dehu mohĩ, harahu kalesa bikāra ||}
\par}
\end{minipage}%
\hfill
...
\textbf{The Sequence of Growth:} We ask first for physical health and strength to act (\textit{Bala}), then mental sharpness to discern clearly (\textit{Budhi}), and finally practical education and skill to succeed (\textit{Bidya}). This is the exact, logical sequence required to overcome life's hardships.
\vspace{0.5em}\newline He modeled the perfect logical growth sequence: first physical endurance, then sharp intellect, then executing the task.\newline\null\hfill\href{https://www.valmiki.iitk.ac.in/sloka?field_kanda_tid=5&language=dv&field_sarga_value=1}{\textit{Sundara Kanda, 1:170}}
\end{tcolorbox}
\end{minipage}
...
\midrule
\deva{बुद्धिहीन} / \telu{బుద్ధిహీన}  &  \deva{बुद्धि-रहितं}  &  Devoid of intelligence  &   \\
\deva{तनु} / \telu{తను}  &  \deva{शरीरं / आत्मानम्}  &  Body / Myself  &   \\
\deva{जानिके} \gotchaicon / \telu{జానికే}  &  \deva{ज्ञात्वा}  &  Having known  & Conjunctive Participle (-ike) \\
\deva{सुमिरौं} / \telu{సుమిరౌఁ}  &  \deva{स्मरामि}  &  I remember/meditate  &   \\
\deva{पवन-कुमार} / \telu{పవన-కుమార}  &  \deva{हे वायुपुत्र}  &  O Son of the Wind  &   \\
\deva{बल} / \telu{బల}  &  \deva{बलम्}  &  Strength  &   \\
\deva{बुधि} \gotchaicon / \telu{బుధి}  &  \deva{बुद्धिम्}  &  Wisdom  & Meter tetris (1+1=2) \\
\deva{बिद्या} / \telu{బిద్యా}  &  \deva{विद्याम्}  &  Knowledge  & \\ 
\deva{देहु} \gotchaicon / \telu{దేహు}  &  \deva{देहि (यच्छ)}  &  Give / Grant  & Imperative -hu ending \\
\deva{मोहिं} \gotchaicon / \telu{మోహిఁ}  &  \deva{मह्यम्}  &  To me  & Dative marker (-hiṃ) \\
\deva{हरहु} \gotchaicon / \telu{హరహు}  &  \deva{हर (दूरीकुरु)}  &  Remove / Destroy  & Imperative -hu ending \\
\deva{कलेस} / \telu{కలేస}  &  \deva{क्लेशान् / दुःखानि}  &  Sufferings  & \\ 
\deva{बिकार} / \telu{బికార}  &  \deva{विकारान् / दोषान्}  &  Impurities / Flaws  & \\ 
\bottomrule
\end{tabularx}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Dative Suffix -hiṃ (\deva{मोहिं}):} Maps to Sanskrit Mahyam ("to me"). "Dehu mohĩ" = Give to me.
