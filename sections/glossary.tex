\newpage
\section*{\deva{परिशिष्ट} (Appendix): Glossary of Terms}
\addcontentsline{toc}{section}{\deva{परिशिष्ट} (Appendix) — Glossary of Terms}

Throughout the Hanuman Chalisa, Tulsidas references a few deep cosmological and esoteric lists from Hindu theology. 
To avoid interrupting the flow of recitation, the detailed definitions of these terms are provided below.
