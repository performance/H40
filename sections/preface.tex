...
\begin{itemize}
    ...
    This is represented by placing a tilde directly over the transliterated vowel (e.g., \deva{तिहुँ} $\rightarrow$ \textit{tihũ} ; \deva{काँपै} $\rightarrow$ \textit{kā̃pai}).  It is read as if that vowel is pronounced normally, but resonating with the help of the nose too. 
\end{itemize}
